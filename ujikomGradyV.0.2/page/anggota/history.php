...
<body>
    ...
    <!-- judul -->
    <div class="coJdl">
        <p class="fa">history&nbsp;&nbsp;peminjaman</p>
    </div>
        ...
        <table class="tbBuku">
            <thead>
                <tr>
                    ...
                    <th style="width: 180px;">Tenggat</th>
            ...
            <tbody>
                <?php
                $datapeminjaman = mysqli_query($conn, "SELECT * FROM peminjaman Where id_user = '" . $_SESSION['user']['id_user'] . "'");
